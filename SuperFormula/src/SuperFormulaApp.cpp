...
void SuperFormulaApp::prepareSettings( Settings* settings )
{
...
void SuperFormulaApp::calculateShape()
{
...
vector<Vec2f> SuperFormulaApp::superformula( float m, float n1, float n2, float n3 )
{
	int numPoints = 360;
...
Vec2f SuperFormulaApp::superformulaPoint( float m, float n1, float n2, float n3, float phi )
{
	float r;
	float t1,t2;
	float a=1,b=1;
